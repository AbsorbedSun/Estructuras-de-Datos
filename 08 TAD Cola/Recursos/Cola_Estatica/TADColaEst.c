...
Descripción: Busca un elemento en la cola estática y retorna su posición
...
/*
void Flip(cola *c)
Descripción: Invierte el orden de los elementos en la cola estática
Recibe: cola *c (Referencia a la cola "c" a operar)
Devuelve: Nada
...
void Flip(cola *c){
    ...
    // Invertimos los elementos directamente en el arreglo
    for(i = 0, j = c->num_elem-1; i < j; i++, j--){
