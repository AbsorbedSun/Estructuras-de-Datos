...
typedef struct elemento
{
	...
	int n;
	char Nom[32];	//Nombre del elemento (hasta 31 caracteres)
	char Act[52];	//Actividad del elemento (hasta 51 caracteres)	
	char ID[8];		//ID del elemento (hasta 7 caracteres)
	int seg;		//Segundos que dura el elemento
	int temF;		//Tiempo restante del elemento
	int temT;		//Tiempo total del elemento
	char c;
	//***
	//***
} elemento;
